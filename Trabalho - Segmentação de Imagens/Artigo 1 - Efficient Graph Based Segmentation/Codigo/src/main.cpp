...
int main(int argc, char** argv) {
    ...
    // 1. PNG → PPM
    std::string convertToPPMCommand = "python3 png_to_ppm.py " + inputPngPath + " " + inputPpmPath;
    ...
    // 7. PPM → PNG
    std::string convertToPNGCommand = "python3 ppm_to_png.py " + outputPpmPath + " " + outputPngPath;
